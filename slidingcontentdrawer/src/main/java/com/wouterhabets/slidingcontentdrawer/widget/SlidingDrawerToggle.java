 ...
 *
 * <p>To use <code>SlidingDrawerToggle</code>, create one in your Activity and call through
 ...
 * has occurred.</p>
 *
 * <p><code>SlidingDrawerToggle</code> can be used directly as a
 ...
 * ActionBar theme.
 */
public class SlidingDrawerToggle implements android.support.v4.widget.DrawerLayout.DrawerListener {

    /**
     * Allows an implementing Activity to return an {@link SlidingDrawerToggle.Delegate} to use
     * with SlidingDrawerToggle.
     */
    ...
    private final SlidingDrawerLayout mSlidingDrawerLayout;
    ...
    /**
     * Construct a new SlidingDrawerToggle.
     *
     ...
     * @param slidingDrawerLayout              The DrawerLayout to link to the given Activity's ActionBar
     * @param openDrawerContentDescRes  A String resource to describe the "open drawer" action
     *                                  for accessibility
     * @param closeDrawerContentDescRes A String resource to describe the "close drawer" action
     *                                  for accessibility
     */
    public SlidingDrawerToggle(Activity activity, SlidingDrawerLayout slidingDrawerLayout,
                               @StringRes int openDrawerContentDescRes,
                               @StringRes int closeDrawerContentDescRes) {
        this(activity, null, slidingDrawerLayout, null, openDrawerContentDescRes,
                closeDrawerContentDescRes);
    }

    /**
     * Construct a new SlidingDrawerToggle with a Toolbar.
     * <p>
     ...
     * <p>
     * Please use {@link #SlidingDrawerToggle(Activity, SlidingDrawerLayout, int, int)} if you are
    ...
    public SlidingDrawerToggle(Activity activity, SlidingDrawerLayout slidingDrawerLayout,
                               ...
                               @StringRes int closeDrawerContentDescRes) {
        this(activity, toolbar, slidingDrawerLayout, null, openDrawerContentDescRes,
                closeDrawerContentDescRes);
    }
     ...
     * animation.
     */
    <T extends Drawable & DrawerToggle> SlidingDrawerToggle(Activity activity, Toolbar toolbar,
                                                            SlidingDrawerLayout slidingDrawerLayout, T slider,
                                                            @StringRes int openDrawerContentDescRes,
                                                            @StringRes int closeDrawerContentDescRes) {
        if (toolbar != null) {
        ...
        mSlidingDrawerLayout = slidingDrawerLayout;
     ...
     * may have diverged in such a way that the SlidingDrawerToggle was not notified.
     * (For example, if you stop forwarding appropriate drawer events for a period of time.)</p>
     */
    public void syncState() {
        if (mSlidingDrawerLayout.isDrawerOpen(GravityCompat.START)) {
        ...
        if (mDrawerIndicatorEnabled) {
            setActionBarUpIndicator((Drawable) mSlider,
                    mSlidingDrawerLayout.isDrawerOpen(GravityCompat.START) ?
    ...
    private void toggle() {
        if (mSlidingDrawerLayout.isDrawerVisible(GravityCompat.START)) {
            mSlidingDrawerLayout.closeDrawer(GravityCompat.START);
        } else {
            mSlidingDrawerLayout.openDrawer(GravityCompat.START);
        }
    }
    ...
    public void setHomeAsUpIndicator(int resId) {
        ...
        if (resId != 0) {
            indicator = mSlidingDrawerLayout.getResources().getDrawable(resId);
        }
     ...
     * SlidingDrawerToggle instance directly as your DrawerLayout's listener, you should call
    ...
    void setActionBarUpIndicator(Drawable upDrawable, int contentDescRes) {
        if (!mWarnedForDisplayHomeAsUp && !mActivityImpl.isNavigationVisible()) {
            Log.w("SlidingDrawerToggle", "DrawerToggle may not show up because NavigationIcon"
